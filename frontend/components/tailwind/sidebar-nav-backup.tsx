...
export default function SidebarNav({
    ...
    // Helper function to truncate names to first 4 characters
    ...
    function SortableFolderItem({ folder }: { folder: Folder }) {
        ...
        return (
            <div ref={setNodeRef} style={style}>
                {/* Folder Item */}
                <div className="flex items-center px-3 py-2 hover:bg-gray-800/50 rounded-lg group relative">
                    ...
                    <button
                        {...attributes}
                        {...listeners}
                        className="p-2 hover:bg-gray-700 rounded transition-colors flex-shrink-0 cursor-grab active:cursor-grabbing opacity-30 group-hover:opacity-100"
                    ...
                    >
                        ...
                        {!isDeleteMode && (
                            <button
                                ...
                                className="bg-gray-700/50 hover:bg-blue-500/30 rounded text-blue-400 hover:text-white transition-all"
                                style={{
                                    width: "32px",
                                    height: "32px",
                                    display: "flex",
                        ...
                        {!isDeleteMode && !isProtectedFolder(folder) && (
                            <button
                                ...
                                className="bg-gray-700/50 hover:bg-red-500/30 rounded text-red-400 hover:text-white transition-all"
                                style={{
                                    width: "32px",
                                    height: "32px",
                                    display: "flex",
                            ...
                            <button
                                onClick={(e) => {
                                    ...
                                    if (onCreateSOW) {
                                        ...
                                        actualOnCreateDocument(
                                            folder.id,
                                            "Untitled Document",
                                        );
                                    }
                                }}
                                className="w-full flex items-center gap-3 px-4 py-2 text-sm text-gray-400 hover:text-[#1CBF79] hover:bg-gray-800/50 rounded transition-colors group"
                                title="Create new SOW in this workspace"
                            >
                                <Plus className="w-4 h-4 group-hover:text-[#1CBF79]" />
    ...
    function SortableDocumentItem({ document }: { document: Document }) {
        ...
        return (
            <div
                ref={setNodeRef}
                style={style}
                className={`px-4 py-2 rounded-lg group transition-colors ${
            ...
            >
                ...
                <div className="flex items-center">
                    ...
                    <button
                        {...attributes}
                        {...listeners}
                        className="p-1.5 hover:bg-gray-700 rounded transition-colors flex-shrink-0 cursor-grab active:cursor-grabbing opacity-30 group-hover:opacity-100"
                        title="Drag to move"
                    >
                    ...
                    <div style={{ width: "350px", marginRight: "16px" }}>
                        {renamingId === document.id ? (
                            ...
                            <button
                                ...
                                className="w-full text-left text-xs hover:text-[#1CBF79] transition-colors block whitespace-normal break-words"
                    ...
                    >
                        ...
                        <button
                            ...
                            className="text-blue-400 hover:bg-blue-500/30 hover:text-blue-300 rounded transition-all"
                            style={{
                                width: "28px",
                                height: "28px",
                                display: "flex",
                        ...
                        <button
                            ...
                            className="text-red-400 hover:bg-red-500/30 hover:text-red-300 rounded transition-all"
                            style={{
                                width: "28px",
                                height: "28px",
                                display: "flex",
    ...
    return (
        <div
            className="h-full bg-[#0E0F0F] border-r border-gray-800 flex flex-col relative sidebar-nav-container"
